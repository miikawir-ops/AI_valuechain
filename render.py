...
// the end. Self-contained: only touches #chain/#chain-fade by id.
...
function buildChain() {{
  ...
  LAYERS.forEach((l, idx) => {{
    ...
    div.className = "layer";
    div.style.cssText = `background:${{c.bg}};border-color:${{c.border}};${{active===l.id?"box-shadow:0 0 0 2px "+c.border:""}}`;
    div.innerHTML = `
